...
# Only process these 7 complete books (based on user annotations)
COMPLETE_BOOKS = {
    'Calculus-3rd-Edition-9780134765631-652',
    'Calculus-8th-Edition-9781285740621-40',
    'College-Algebra-10th-Edition-9780321999412-6',
    'College-Algebra-2nd-Edition-9780077836344-117',
    'College-Algebra-7th-Edition-9780134469164-48',
...
def main():
    ...
    for p in SOURCE_DIR.glob('*.har'):
        ...
        for e in data.get('log', {}).get('entries', []):
            ...
            # Only process complete books
            book_slug = parsed['book']
            if book_slug not in COMPLETE_BOOKS:
                continue
        ...
        print(f"    ✓ Extracted {count} complete book problems")
    ...
    print(f"Total complete books found: {len(by_book)}\n")
    ...
    print("Step 2: Processing complete books...")
    ...
    print(f"\n✓ Complete! Processed {global_problem_id - 1} total problems from {len(by_book)} complete books")
